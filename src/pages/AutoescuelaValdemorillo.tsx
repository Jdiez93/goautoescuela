        ...
        <section className="px-4 mb-16">
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
            ...
            <motion.div {...fadeUp} transition={{ duration: 0.7, delay: 0.2, ease: easeCurve }} className="rounded-3xl border border-border/40 bg-card/30 backdrop-blur-sm p-6 hover:border-primary/50 transition-all">
              ...
              <p className="text-sm text-foreground font-semibold mb-1">Valdemorillo</p>
              <a href="tel:+34645343117" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                645 34 31 17
              </a>
            </motion.div>
          </div>
