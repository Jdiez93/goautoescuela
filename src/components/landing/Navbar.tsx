            ...
            {navLinks.map((link) => {
              ...
              if (link.children) {
                return (
                  <div key={link.to} className="relative group">
                    <span
                      className={cn(
                        "relative px-3 py-2 text-sm xl:text-base font-medium rounded-lg transition-colors duration-200 cursor-pointer inline-flex items-center gap-1",
              ...
              return (
                <Link key={link.to} to={link.to}>
                  <span
                    className={cn(
                      "relative px-3 py-2 text-sm xl:text-base font-medium rounded-lg transition-colors duration-200",
                      isActive
                        ? "text-foreground"
                        : "text-muted-foreground hover:text-foreground"
                    )}
